...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.fetchSearchGiphys = _actions_giphy_actions__WEBPACK_IMPORTED_MODULE_5__["default"];
  window.store = store;
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: "GET",
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=zFH387ggqdmMJF3OO7UDgkwcQx1PQa2w&limit=2")
  });
};
